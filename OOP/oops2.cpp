...
//     s1.name = "Smitanshu";
//     cout << s1.name << endl;
//     //It Gives error if data member  "name " is declared in private
...
// Also called ctor it is the only function in cpp which does not have return type
...
//     int marks;
//     bool present;
//     // It created Ctor by programmer now he dont add defaultly.
//     // If default constructor is created in private then you cant use that box of class to any object.
...
//     // This call the polymorphism concept how he knows that without absent parameter constructor
